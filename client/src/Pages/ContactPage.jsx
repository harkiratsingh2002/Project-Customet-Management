                                    ...
                                    <div className="bg-white border rounded shadow-sm overflow-hidden">
                                        ...
                                        <form onSubmit={sendMessage}>
                                            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                                ...
                                                <div class="col-12">
                                                    <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>subject                                                <input type="text" class="form-control" id="subject" name="subject" required placeholder="Interesed in the featured car" value={data.subject} onChange={(e) => setData({ ...data, subject: e.target.value })} />
                                                </div>
                                                <div class="col-12">
