                            ...
                            <div class="col-12 col-lg-6">
                                <div class="row justify-content-xl-center">
                                    <div class="col-12 col-xl-11">
                                        ...
                                        <p class="lead fs-4 text-secondary mb-5">We're always on the lookout to satisfy our customer needs. If you're interested in your next purchase, please get in touch in one of the following ways.</p>
                                        ...
                                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="+61456789065" />
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="subject" name="subject" required placeholder="Interesed in the featured car" />
                                            </div>
                                            <div class="col-12">
                                                <label for="message" class="form-label">Message <span class="text-danger">*</span></label>
                                                <textarea class="form-control" id="message" name="message" rows="3" required placeholder=" I would like to know more about this car."  ></textarea>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
