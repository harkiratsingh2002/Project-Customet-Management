        ...
        <nav class="navbar navbar-expand-lg  mt-0 pt-0 pb-0 " >
            <div class="container-fluid ">
                ...
                <div class="collapse navbar-collapse fw-bold " id="navbarNavDropdown">
                    ...
                    <div class="col">
                        <a href="#/login"><button type="button" class="btn dark-bg light-text me-3  ">Log In</button></a>
                        <a href="#/register"><button type="button" class="btn dark-bg light-text me-3 ">Sign In</button></a>
                    </div>
                </div>
